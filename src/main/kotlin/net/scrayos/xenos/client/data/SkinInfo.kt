...
import scrayosnet.xenos.ProfileOuterClass.SkinResponse
import java.awt.image.BufferedImage
import java.time.Instant

/**
 * A [SkinInfo] is the response to the request of the skin texture of a specific player. The result includes the
 ...
 */
data class SkinInfo(
    /** The loaded texture of the skin that was requested for the supplied player. */
